...
/**
 * An activity representing a list of Mutes. This activity
 * has different presentations for handset and tablet-size devices. On
 * handsets, the activity presents a list of items, which when touched,
 * lead to a {@link MuteDetailActivity} representing
 * item details. On tablets, the activity presents the list of items and
 * item details side-by-side using two vertical panes.
 * <p>
 * The activity makes heavy use of fragments. The list of items is a
 * {@link MuteListFragment} and the item details
 * (if present) is a {@link MuteDetailFragment}.
 * <p>
 * This activity also implements the required
 * {@link MuteListFragment.Callbacks} interface
...
public class MuteListActivity extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.mute_detail_container) != null) {
            ...
            ((MuteListFragment) getFragmentManager()
                    .findFragmentById(R.id.mute_list))
    ...
    /**
     * Callback method from {@link MuteListFragment.Callbacks}
    ...
    public void onItemSelected(long id) {
        if (mTwoPane) {
            ...
            arguments.putLong(MuteDetailFragment.ARG_ITEM_ID, id);
            ...
            detailIntent.putExtra(MuteDetailFragment.ARG_ITEM_ID, id);
